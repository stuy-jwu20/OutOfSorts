...
public class Tester {
  ...
  public static void insertionTester() {
    // insertionSort() with unsorted and random values //
        ...
        if (equalAmount == testCases) {
          System.out.println("insertionSort() passed with unsorted and random values!");
        }
    ...
    // bubbleSort() if length is 0 //
        ...
        if (zeroData.equals(sorted0Data)) {
          System.out.println("insertionSort() works with 0 data!");
        } else {
          System.out.println("They are not equal with 0 cases.");
          System.out.println("Expected: \n" + zeroData);
          System.out.println("Actual: \n" + Arrays.toString(zeroCases));
    ...
    // bubbleSort() if length is 1 //
        ...
        if (singleEqualAmount == testCases) {
            System.out.println("insertionSort() works with 1 data!");
        }
  ...
  public static void selectionTester() {
    ...
    // bubbleSort() if length is 0 //
        ...
        if (zeroData.equals(sorted0Data)) {
          System.out.println("selectionSort() works with 0 data!");
        } else {
          System.out.println("They are not equal with 0 cases.");
          System.out.println("Expected: \n" + zeroData);
          System.out.println("Actual: \n" + Arrays.toString(zeroCases));
    ...
    // bubbleSort() if length is 1 //
        ...
        if (singleEqualAmount == testCases) {
            System.out.println("selectionSort() works with 1 data!");
        }
